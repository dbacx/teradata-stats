...
SELECT LogDate,
       SUM (AMPCPUTime + Parsercputime) (NAMED SumCPU) , SUM (CASE
                                                                           WHEN (TotalIOCount > 0
                                                                           ...
                                                                           ELSE 0
                                                                       END) (NAMED SuspectCPU) , MAXIMUM (SystemCPUPerNode) (NAMED SystemCPUPerNode) , MAXIMUM (TotalSystemCPU) (NAMED TotalSystemCPU)
  ...
  FROM pdcrinfo.dbqlogtbl_hst a,
        ...
        (SELECT NodeType,
               NCPUs * 86400 AS SystemCPUPerNode,
