...
SELECT WDName,
       ...
       COUNT (1) AS AbortCount,

       CASE
                                                       WHEN errorcode IN (3149, 3150,
                                                                          3151, 3152,
                                                                          3153, 3154,
                                                                          3155, 3156,
                                                                          3162, 3163,
                                                                          3298) THEN 'TASM Aborted'

            WHEN errorcode IN (2646, 3134,
                                                                          3110)                                                                                                                                                                                                                                                                                                                                                             THEN 'User Aborted'

             END (NAMED AbortType) , Errortext,
