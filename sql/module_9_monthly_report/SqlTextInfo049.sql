...
-- =============================================================================
 LOCK ROW
   ...
   FOR ACCESS
SELECT CPU_Thresholds,
       COUNT (1) (NAMED Unique_SQL_Count) , SUM (CASE
                                                                     WHEN CPUSkew_GT50PCT > 0 THEN 1 ELSE 0
                                                                 END) (NAMED CPU_Skew_GT_50_PCT) , SUM (CASE
                                                                                                            WHEN IOSkew_GT50PCT > 0 THEN 1
                                                                                                            ELSE 0
                                                                                                        END) (NAMED IO_Skew_GT_50_PCT) , SUM (CASE
                                                                                                                                                  WHEN PJI_GT3 > 0 THEN 1
                                                                                                                                                  ELSE 0
                                                                                                                                              END) (NAMED PJI_GT_3) , SUM (CASE
                                                                                                                                                                               WHEN PJI_GT5 > 0 THEN 1
                                                                                                                                                                               ELSE 0
                                                                                                                                                                           END) (NAMED PJI_GT_5) , SUM (CASE
                                                                                                                                                                                                            WHEN PJI_GT10 > 0 THEN 1
                                                                                                                                                                                                            ELSE 0
                                                                                                                                                                                                        END) (NAMED PJI_GT_10) , SUM (CASE
                                                                                                                                                                                                                                          WHEN UII_GT3 > 0 THEN 1
                                                                                                                                                                                                                                          ELSE 0
                                                                                                                                                                                                                                      END) (NAMED UII_GT_3) , SUM (CASE
                                                                                                                                                                                                                                                                       WHEN UII_GT5 > 0 THEN 1
                                                                                                                                                                                                                                                                       ELSE 0
                                                                                                                                                                                                                                                                   END) (NAMED UII_GT_5) , SUM (CASE
                                                                                                                                                                                                                                                                                                    WHEN UII_GT10 > 0 THEN 1
                                                                                                                                                                                                                                                                                                    ELSE 0
                                                                                                                                                                                                                                                                                                END) (NAMED UII_GT_10) , SUM (CASE
                                                                                                                                                                                                                                                                                                                                  WHEN PJI_GT3 > 0
                                                                                                                                                                                                                                                                                                                                       OR UII_GT3 > 0
                                                                                                                                                                                                                                                                                                                                       OR CPUSkew_GT50PCT > 0
                                                                                                                                                                                                                                                                                                                                       OR IOSkew_GT50PCT > 0 THEN 1
                                                                                                                                                                                                                                                                                                                                  ELSE 0
                                                                                                                                                                                                                                                                                                                              END) (NAMED OverallSuspect3Count) , SUM (CASE
                                                                                                                                                                                                                                                                                                                                                                           WHEN PJI_GT5 > 0
                                                                                                                                                                                                                                                                                                                                                                                OR UII_GT5 > 0
                                                                                                                                                                                                                                                                                                                                                                                OR CPUSkew_GT50PCT > 0
                                                                                                                                                                                                                                                                                                                                                                                OR IOSkew_GT50PCT > 0 THEN 1
                                                                                                                                                                                                                                                                                                                                                                           ELSE 0
                                                                                                                                                                                                                                                                                                                                                                       END) (NAMED OverallSuspect5Count) , SUM (CASE
                                                                                                                                                                                                                                                                                                                                                                                                                    WHEN PJI_GT10 > 0
                                                                                                                                                                                                                                                                                                                                                                                                                         OR UII_GT10 > 0
                                                                                                                                                                                                                                                                                                                                                                                                                         OR CPUSkew_GT50PCT > 0
                                                                                                                                                                                                                                                                                                                                                                                                                         OR IOSkew_GT50PCT > 0 THEN 1
                                                                                                                                                                                                                                                                                                                                                                                                                    ELSE 0
                                                                                                                                                                                                                                                                                                                                                                                                                END) (NAMED OverallSuspect10Count)

  FROM

        (SELECT HASHROW (COALESCE(sq.SQLTextInfo, md.querytext)) (NAMED SQLRowHash) , CASE
                                                                                      WHEN AMPCPUTime >= 0
